...
source "amazon-ebs" "linux2" {
  ami_name                    = "waypoint_server_linux2_${local.image_suffix}"
  ...
  tags                        = merge({ Name = "waypoint_server_linux2_${local.image_suffix}" }, var.tags)
  snapshot_tags               = merge({ Name = "waypoint_server_linux2_${local.image_suffix}" }, var.tags)
