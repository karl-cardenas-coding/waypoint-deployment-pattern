#!/bin/sh
## INFO 
#The script expects the environement variable WAYPOINT_BACKUP_BUCKET to be available
...
# The paramter name is defined and created in the terraform main.tf file. 
# Look for the AWS SSM Paramter resource named "waypoint-backup"
